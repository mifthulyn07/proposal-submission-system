<section>
    <header>
        <h2 id="complete-profile" class="text-lg font-medium text-gray-900">
    ...
    @if (session()->has('warning'))
        <div
            ...
            class="mt-3 flex align-center justify-center alert-remove p-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-400" 
            role="alert"
        >
