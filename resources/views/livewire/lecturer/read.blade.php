    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm rounded-lg">
            ...
            <div class="m-4 flex items-center justify-between bg-white dark:bg-gray-900">
                {{-- button --}}
                <div class="mr-2">
                    <a href="{{ Route('lecturer.create') }}" class="inline-flex items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add</a>
                </div>
                {{-- search --}}
                            ...
                            @foreach ( $lecturers as $index => $lecturer )
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <th scope="row" class="px-6 py-4">
                                        ...
                                        <div class="font-normal text-gray-500">{{ $lecturer->user->email }}</div>
                                    </th>
                                    <td class="px-6 py-4">
                                        {{ $lecturer->nip }}
                                    </td>
                                    ...
                                    <td class="p-4 space-x-1 whitespace-nowrap">
                                        <a wire:click="editIdLecturer({{ $lecturer->id }})" wire:click.prevent class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-yellow-300 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 dark:bg-yellow-300 dark:hover:bg-yellow-300 dark:focus:ring-yellow-300">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path><path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd"></path></svg>
                                        </a>
                                        <a wire:click="deleteIdLecturer({{ $lecturer->id }})" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900" x-data="" x-on:click.prevent="$dispatch('open-modal', 'confirm-lecturer-deletion')">
            ...
            {{-- delete modal --}}
            <x-modal wire:ignore.self name="confirm-lecturer-deletion" :show="$errors->lecturerDeletion->isNotEmpty()" focusable>
                <div class="p-6" wire:loading wire:target="deleteIdLecturer()">
                    <p>loading...</p>
                </div>
                <div class="p-6">
                    <div class="p-2 text-center">
                        <svg aria-hidden="true" class="mx-auto mb-4 text-gray-400 w-14 h-14 dark:text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete <span class="text-gray-900 font-semibold">{{ $deleteIdLecturerName }}</span> from lecturer role?</h3>
                    </div>
                    ...
                    <div class="flex justify-end">
                        ...
                        <x-danger-button class="ml-3" wire:click.prevent="deleteLecturer()" x-on:click="$dispatch('close')">
