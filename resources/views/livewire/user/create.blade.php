            ...
            <div class="m-4">
                ...
                <form class="mt-6" wire:submit.prevent="store">
                    ...
                    <div class="mb-6">
                        <div>
                            @if ($avatar)
                                <div class="flex flex-col items-center pb-2">
                                    <img class="object-cover w-24 h-24 rounded-full shadow-lg" src="{{ $avatar->temporaryUrl() }}" alt="Bonnie image"/>
                        ...
                        <input type="file" wire:model="avatar" id="{{ rand() }}" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
