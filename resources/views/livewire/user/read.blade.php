                                    ...
                                    <td class="px-6 py-4">
                                        @foreach ($user->roles as $role)
                                            ...
                                            @elseif($role->name == 'student')
                                                <span class="bg-yellow-100 text-yellow-800 text-xs font-medium mr-0.5 mb-1 px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">Stu</span>
                                            @endif
                                        @endforeach
                                    </td>
                                    <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        @if($user->avatar)
                                            <img class="object-cover w-10 h-10 rounded-full" src="{{ asset('storage/'.$user->avatar) }}" alt="avatar"/>
                                        @else                    
