    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            @if (auth()->user()->hasRole('coordinator'))
                <li>
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        <li>
                            <a href="{{ Route('user.read') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">User Account</a>
                        </li>
                        <li>
                            <a href="{{ Route('topic.read') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Topics</a>
                        </li>
                    </ul>
                </li>
                <li>
            ...
            @if (auth()->user()->hasRole('student'))
                {{-- submit proposals --}}
                <li>
                    <a href="{{ Route('submit-proposal.read')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
